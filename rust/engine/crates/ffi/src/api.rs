...
pub use query::{
    ...
    panda_engine_get_effect_type, panda_engine_get_effects_count, panda_engine_get_effects_types,
    panda_engine_get_last_error_message, panda_engine_get_last_event_message,
    panda_engine_get_pending_library_track_id, panda_engine_get_profile_preference_value,
