...
pub struct FfiEngineSnapshot {
    ...
    pub saved_tracks_count: usize,
    pub liked_tracks_count: usize,
    pub library_pending_count: usize,
    pub has_saved_tracks_next_page: bool,
    pub has_liked_tracks_next_page: bool,
    pub playlists_count: usize,
    pub playlist_tracks_count: usize,
    pub has_playlists_next_page: bool,
    pub has_playlist_tracks_next_page: bool,
    pub has_playlist_reconciliation: bool,
    pub has_protected_account: bool,
    pub device_sessions_count: usize,
    pub has_device_sessions_next_page: bool,
...
impl FfiEngineSnapshot {
    pub(crate) fn invalid() -> Self {
        Self {
            ...
            library_pending_count: 0,
            has_saved_tracks_next_page: false,
            has_liked_tracks_next_page: false,
            playlists_count: 0,
            playlist_tracks_count: 0,
            has_playlists_next_page: false,
            has_playlist_tracks_next_page: false,
            has_playlist_reconciliation: false,
            has_protected_account: false,
            device_sessions_count: 0,
            has_device_sessions_next_page: false,
...
impl From<&EngineSnapshot> for FfiEngineSnapshot {
    fn from(snapshot: &EngineSnapshot) -> Self {
        Self {
            ...
            saved_tracks_count: snapshot.saved_tracks.len(),
            liked_tracks_count: snapshot.liked_tracks.len(),
            library_pending_count: snapshot.library_pending_track_ids.len(),
            has_saved_tracks_next_page: snapshot.saved_tracks_next_page_token.is_some(),
            has_liked_tracks_next_page: snapshot.liked_tracks_next_page_token.is_some(),
            playlists_count: snapshot.playlists.len(),
            playlist_tracks_count: snapshot.playlist_tracks.len(),
            has_playlists_next_page: snapshot.playlists_next_page_token.is_some(),
            has_playlist_tracks_next_page: snapshot.playlist_tracks_next_page_token.is_some(),
            has_playlist_reconciliation: snapshot.playlist_reconciliation.is_some(),
            has_protected_account: snapshot.protected_account.is_some(),
            device_sessions_count: snapshot.device_sessions.len(),
            has_device_sessions_next_page: snapshot.device_sessions_next_page_token.is_some(),
