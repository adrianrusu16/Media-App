...
data class LibraryHistoryEntry(
...
data class LibraryState(
    ...
    val historyEntries: List<LibraryHistoryEntry> = emptyList(),
    ...
    val selectedTracks: List<LibraryTrack>
        get() = when (selectedTab) {
            ...
            LibraryTab.PLAYLISTS -> playlistTracks
        }
    ...
    val hasSelectedNextPage: Boolean
        get() = when (selectedTab) {
            ...
            LibraryTab.HISTORY -> hasHistoryNextPage
