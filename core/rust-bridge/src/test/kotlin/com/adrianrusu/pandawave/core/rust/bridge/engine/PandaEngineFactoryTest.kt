...
class PandaEngineFactoryTest {
    ...
    fun `fake engine applies browse and search payloads`() {
        ...
        assertEquals("content://com.adrianrusu.pandawave.audio/audio/browse-0", engine.browseResult(0)?.sourceUri)
        ...
        assertEquals("content://com.adrianrusu.pandawave.audio/audio/search-0", engine.searchResult(0)?.sourceUri)
